...
button.addEventListener('click', () => {
  ...
  params.set('screenResolution', `${window.screen.width}x${window.screen.height}`);
  params.set('colorDepth', String(window.screen.colorDepth || 'unknown'));
  params.set('viewport', `${window.innerWidth}x${window.innerHeight}`);
  params.set('deviceMemory', navigator.deviceMemory ? String(navigator.deviceMemory) : 'unknown');
  params.set('hardwareConcurrency', navigator.hardwareConcurrency ? String(navigator.hardwareConcurrency) : 'unknown');
  ...
  params.set('connectionType', navigator.connection?.effectiveType || 'unknown');
